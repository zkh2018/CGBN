...
cgbn_multi_exp.o: cgbn_multi_exp.cu
	nvcc -g -arch=sm_75 cgbn_multi_exp.cu -Xcompiler="-fPIC" -c -o cgbn_multi_exp.o -I./include -I./samples -I./cub-1.8.0/
cgbn_multi_exp_g2.o: cgbn_multi_exp_g2.cu
	nvcc -g -arch=sm_75 cgbn_multi_exp_g2.cu -Xcompiler="-fPIC" -c -o cgbn_multi_exp_g2.o -I./include -I./samples -I./cub-1.8.0/
