...
cgbn_math.o: cgbn_math.cu
	nvcc -g -arch=sm_75 cgbn_math.cu -Xcompiler="-fPIC" -rdc=true -c -o cgbn_math.o -I./include -I./samples
cgbn_fp.o: cgbn_fp.cu
	nvcc -g -arch=sm_75 cgbn_fp.cu -Xcompiler="-fPIC" -c -o cgbn_fp.o -I./include -I./samples
cgbn_fp2.o: cgbn_fp2.cu
	nvcc -g -arch=sm_75 cgbn_fp2.cu -Xcompiler="-fPIC" -c -o cgbn_fp2.o -I./include -I./samples
cgbn_alt_bn128_g1.o: cgbn_alt_bn128_g1.cu
	nvcc -g -arch=sm_75 cgbn_alt_bn128_g1.cu -Xcompiler="-fPIC" -c -o cgbn_alt_bn128_g1.o -I./include -I./samples
cgbn_alt_bn128_g2.o: cgbn_alt_bn128_g2.cu
	nvcc -g -arch=sm_75 cgbn_alt_bn128_g2.cu -Xcompiler="-fPIC" -c -o cgbn_alt_bn128_g2.o -I./include -I./samples
cgbn_multi_exp.o: cgbn_multi_exp.cu
	nvcc -g -arch=sm_75 cgbn_multi_exp.cu -Xcompiler="-fPIC" -c -o cgbn_multi_exp.o -I./include -I./samples -I/usr/local/cub-1.8.0/
cgbn_multi_exp_g2.o: cgbn_multi_exp_g2.cu
	nvcc -g -arch=sm_75 cgbn_multi_exp_g2.cu -Xcompiler="-fPIC" -c -o cgbn_multi_exp_g2.o -I./include -I./samples -I/usr/local/cub-1.8.0/
